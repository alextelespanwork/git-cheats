...
4--to tell the command to try to reapply the staged changes
* git stash apply --[filename]

5--to remove a stash
* git stash drop stash@{0}

6--to apply the stash and then immediately drop it from your stack
* git stash pop

7--to stash the files exept the filename file
* git stash --keep-(filename)

8--when you may not want to stash some work or files in your working directory, but simply get rid of them. 
